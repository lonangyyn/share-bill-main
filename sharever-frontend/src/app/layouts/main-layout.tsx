...
export default function MainLayout() {
  return (
    ...
    <div className="flex h-screen w-full bg-[#F8F9FC] overflow-hidden font-sans text-gray-900">
      <aside className="w-50 h-full flex-shrink-0 bg-white border-r border-gray-100 flex flex-col z-20 transition-all duration-300">
        <Sidebar />
      </aside>
      ...
      <div className="flex-1 flex flex-col h-full relative min-w-0">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden scroll-smooth">
          {/* Header */}
          <div className="sticky top-0 z-10 bg-[#F8F9FC]/90 backdrop-blur-sm">
            <Header />
          </div>
